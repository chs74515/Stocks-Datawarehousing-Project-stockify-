...
!function (e, t) {
    ...
    w.fn = w.prototype = {
        ...
        for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || g(a) || (a = {}), s === l && (a = this, s--); s < l; s++) if (null != (e = arguments[s])) for (t in e) n = a[t], a !== (i = e[t]) && (c && i && (w.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, o = n && Array.isArray(n) ? n : []) : o = n && w.isPlainObject(n) ? n : {}, a[t] = w.extend(c, o, i)) : void 0 !== i && (a[t] = i));
        return a
    }, w.extend({
    ...
    var S = function (e) {
        var t, n, i, r, o, a, s, l, c, u, d, f, h, p, g, m, v, y, b, w = "sizzle" + 1 * new Date, _ = e.document, x = 0,
            S = 0, C = ae(), T = ae(), E = ae(), k = function (e, t) {
                return e === t && (d = !0), 0
            }, O = {}.hasOwnProperty, A = [], D = A.pop, P = A.push, N = A.push, I = A.slice, L = function (e, t) {
            ...
            V = new RegExp("=" + M + "*([^\\]'\"]*?)" + M + "*\\]", "g"), X = new RegExp(W),
            Y = new RegExp("^" + $ + "$"), U = {
                ID: new RegExp("^#(" + $ + ")"),
                CLASS: new RegExp("^\\.(" + $ + ")"),
                TAG: new RegExp("^(" + $ + "|[*])"),
            ...
            }, z = /^(?:input|select|textarea|button)$/i, Q = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/,
            G = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Z = /[+~]/,
        ...
        try {
            N.apply(A = I.call(_.childNodes), _.childNodes), A[_.childNodes.length].nodeType
        } catch (e) {
            N = {
        ...
        function oe(e, t, i, r) {
            var o, s, c, u, d, p, v, y = t && t.ownerDocument, x = t ? t.nodeType : 9;
                ...
                TAG: function (e) {
                    ...
                    return 1 === i && 0 === r ? function (e) {
                        ...
                        if (m) {
                            ...
                            } else if (y && (b = h = (c = (u = (d = (f = t)[w] || (f[w] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === x && c[1]), !1 === b) for (; (f = ++h && f && f[g] || (b = h = 0) || p.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && ((u = (d = f[w] || (f[w] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [x, b]), f !== t));) ;
        ...
        function _e(e, t, n, i, r, o) {
            return i && !i[w] && (i = _e(i)), r && !r[w] && (r = _e(r, o)), se(function (o, a, s, l) {
                var c, u, d, f = [], h = [], p = a.length, g = o || function (e, t, n) {
                        ...
                        return n
                    }(t || "*", s.nodeType ? [s] : s, []), m = !e || !o && t ? g : we(g, f, e, s, l),
                    v = n ? r || (o ? e : p || i) ? [] : a : m;
                if (n && n(m, v, s, l), i) for (c = we(v, h), i(c, [], s, l), u = c.length; u--;) (d = c[u]) && (v[h[u]] = !(m[h[u]] = d));
                if (o) {
                    if (r || e) {
                        if (r) {
        ...
        function Se(e, t) {
            var n = t.length > 0, r = e.length > 0, o = function (o, a, s, l, u) {
                var d, p, m, v = 0, y = "0", b = o && [], w = [], _ = c, S = o || r && i.find.TAG("*", u),
                    C = x += null == _ ? 1 : Math.random() || .1, T = S.length;
                ...
                if (v += y, n && y !== v) {
                    ...
                    N.apply(l, w), u && !o && w.length > 0 && v + t.length > 1 && oe.uniqueSort(l)
                }
                return u && (x = C, c = _), b
            };
            return n ? se(o) : o
        ...
        return me.prototype = i.filters = i.pseudos, i.setFilters = new me, a = oe.tokenize = function (e, t) {
            ...
            if (n = n || [], 1 === h.length) {
                ...
                for (o = U.needsContext.test(e) ? 0 : l.length; o-- && (c = l[o], !i.relative[u = c.type]);) if ((d = i.find[u]) && (r = d(c.matches[0].replace(J, ee), Z.test(l[0].type) && ge(t.parentNode) || t))) {
    ...
    (w.fn.init = function (e, t, n) {
        ...
        if (n = n || D, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : i, !0)), O.test(r[1]) && w.isPlainObject(t)) for (r in t) g(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                return this
            }
            return (o = i.getElementById(r[2])) && (this[0] = o, this.length = 1), this
        }
        return e.nodeType ? (this[0] = e, this.length = 1, this) : g(e) ? void 0 !== n.ready ? n.ready(e) : e(w) : w.makeArray(e, this)
    }).prototype = w.fn, D = w(i);
    ...
    w.fn.extend({
        has: function (e) {
            ...
            if (!E.test(e)) for (; i < r; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && w.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
        ...
        w.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = w.filter(i, r)), this.length > 1 && (I[e] || w.uniqueSort(r), N.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var j = /[^\x20\t\r\n\f]+/g;
    ...
    w.Callbacks = function (e) {
        ...
        Deferred: function (t) {
                ...
                i = "pending", r = {
                    state: function () {
                            ...
                            return function () {
                                var s = this, l = arguments, c = function () {
                                    ...
                                    if (!(t < o)) {
                                        ...
                                        c = e && ("object" == typeof e || "function" == typeof e) && e.then, g(c) ? r ? c.call(e, a(o, n, M, r), a(o, n, $, r)) : (o++, c.call(e, a(o, n, M, r), a(o, n, $, r), a(o, n, M, n.notifyWith))) : (i !== M && (s = void 0, l = [e]), (r || n.resolveWith)(s, l))
                                    }
                                }, u = r ? c : function () {
                                    try {
                                        c()
                                    } catch (e) {
                                        w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, u.stackTrace), t + 1 >= o && (i !== $ && (s = void 0, l = [e]), n.rejectWith(s, l))
                                    }
                                };
                        ...
                        return w.Deferred(function (e) {
                            n[0][3].add(a(0, e, g(r) ? r : M, e.notifyWith)), n[1][3].add(a(0, e, g(t) ? t : M)), n[2][3].add(a(0, e, g(i) ? i : $))
                        }).promise()
                    }, promise: function (e) {
            ...
            if (t <= 1 && (H(e, a.done(s(n)).resolve, a.reject, !t), "pending" === a.state() || g(r[n] && r[n].then))) return a.then();
    ...
    var F = function (e, t, n, i, r, o, a) {
        ...
        if ("object" === b(n)) for (s in r = !0, n) F(e, t, s, n[s], !0, o, a); else if (void 0 !== i && (r = !0, g(i) || (a = !0), c && (a ? (t.call(e, i), t = null) : (c = t, t = function (e, t, n) {
            return c.call(w(e), n)
    ...
    var Q = new z, K = new z, G = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Z = /[A-Z]/g;
    ...
    function me(e, t, n, i, r) {
        for (var o, a, s, l, c, u, d = t.createDocumentFragment(), f = [], h = 0, p = e.length; h < p; h++) if ((o = e[h]) || 0 === o) if ("object" === b(o)) w.merge(f, o.nodeType ? [o] : o); else if (ge.test(o)) {
        ...
        for (d.textContent = "", h = 0; o = f[h++];) if (i && w.inArray(o, i) > -1) r && r.push(o); else if (c = w.contains(o.ownerDocument, o), a = he(d.appendChild(o), "script"), c && pe(a), n) for (u = 0; o = a[u++];) de.test(o.type || "") && n.push(o);
        return d
    }
    ...
    w.event = {
        global: {}, add: function (e, t, n, i, r) {
            ...
            if (m) for (n.handler && (n = (o = n).handler, r = o.selector), r && w.find.matchesSelector(ve, r), n.guid || (n.guid = w.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function (t) {
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(j) || [""]).length; c--;) if (h = g = (s = we.exec(t[c]) || [])[1], p = (s[2] || "").split(".").sort(), h) {
    ...
    function Ne(e, t) {
        var n, i, r, o, a, s, l, c;
        if (1 === t.nodeType) {
            if (Q.hasData(e) && (o = Q.access(e), a = Q.set(t, o), c = o.events)) for (r in delete a.handle, a.events = {}, c) for (n = 0, i = c[r].length; n < i; n++) w.event.add(t, r, c[r][n]);
    ...
    function Le(e, t, n, i) {
        t = a.apply([], t);
        var r, o, s, l, c, u, d = 0, f = e.length, h = f - 1, m = t[0], v = g(m);
        ...
        if (f && (o = (r = me(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
            for (l = (s = w.map(he(r, "script"), De)).length; d < f; d++) c = r, d !== h && (c = w.clone(c, !0, !0), l && w.merge(s, he(c, "script"))), n.call(e[d], c, d);
            if (l) for (u = s[s.length - 1].ownerDocument, w.map(s, Pe), d = 0; d < l; d++) c = s[d], de.test(c.type || "") && !Q.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && w._evalUrl(c.src) : y(c.textContent.replace(Oe, ""), u, c))
        }
        return e
    }
    ...
    w.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (a = he(s), i = 0, r = (o = he(e)).length; i < r; i++) Ie(o[i], a[i]);
            if (t) if (n) for (o = o || he(e), a = a || he(s), i = 0, r = o.length; i < r; i++) Ne(o[i], a[i]); else Ne(e, s);
            return (a = he(s, "script")).length > 0 && pe(a, !l && he(e, "script")), s
        }, cleanData: function (e) {
            for (var t, n, i, r = w.event.special, o = 0; void 0 !== (n = e[o]); o++) if (U(n)) {
                if (t = n[Q.expando]) {
    ...
    var Me = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"), $e = function (t) {
    ...
    function We(e, t, n) {
        ...
        return (n = n || $e(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || w.contains(e.ownerDocument, e) || (a = w.style(e, t)), !p.pixelBoxStyles() && Me.test(a) && He.test(t) && (i = s.width, r = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = r, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    !function () {
        ...
        var r, o, a, s, l, c = i.createElement("div"), u = i.createElement("div");
    ...
    var qe = /^(none|table(?!-c[ea]).+)/, Fe = /^--/,
        ...
        Ve = {letterSpacing: "0", fontWeight: "400"}, Xe = ["Webkit", "Moz", "ms"], Ye = i.createElement("div").style;
    ...
    function Ke(e, t, n) {
        var i = $e(e), r = We(e, t, i), o = "border-box" === w.css(e, "boxSizing", !1, i), a = o;
        if (Me.test(r)) {
            if (!n) return r;
            r = "auto"
        }
    ...
    w.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, a, s = Y(t), l = Fe.test(t), c = e.style;
        ...
        w.cssHooks[t] = {
            get: function (e, n, i) {
                ...
                var r, o = $e(e), a = "border-box" === w.css(e, "boxSizing", !1, o), s = i && Qe(e, t, i, a, o);
        ...
        css: function (e, t) {
            return F(this, function (e, t, n) {
                var i, r, o = {}, a = 0;
                if (Array.isArray(t)) {
                    for (i = $e(e), r = t.length; a < r; a++) o[t[a]] = w.css(e, t[a], !1, i);
                    return o
                }
    ...
    function at(e, t, n) {
        ...
        }(u, c.opts.specialEasing); o < a; o++) if (i = at.prefilters[o].call(c, e, u, c.opts)) return g(i.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
    ...
    w.Animation = w.extend(at, {
        ...
        fadeTo: function (e, t, n, i) {
            ...
            return !1 !== e && (e = e || "fx"), this.each(function () {
                var t, n = Q.get(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = w.timers, a = i ? i.length : 0;
    ...
    w.fn.extend({
        ...
        addClass: function (e) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : g(e) ? this.each(function (n) {
                ...
                var t, r, o, a;
                if (i) for (r = 0, o = w(this), a = ht(e); t = a[r++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || ((t = ft(this)) && Q.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Q.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, i = 0;
            ...
            option: {
                ...
                get: function (e) {
                    var t, n, i, r = e.options, o = e.selectedIndex, a = "select-one" === e.type, s = a ? null : [],
                        l = a ? o + 1 : r.length;
                    for (i = o < 0 ? l : a ? o : 0; i < l; i++) if (((n = r[i]).selected || i === o) && !n.disabled && (!n.parentNode.disabled || !k(n.parentNode, "optgroup"))) {
    ...
    w.extend(w.event, {
        trigger: function (t, n, r, o) {
            var a, s, l, c, u, f, h, p, v = [r || i], y = d.call(t, "type") ? t.type : t,
            ...
            if (s = p = l = r = r || i, 3 !== r.nodeType && 8 !== r.nodeType && !gt.test(y + w.event.triggered) && (y.indexOf(".") > -1 && (y = (b = y.split(".")).shift(), b.sort()), u = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), h = w.event.special[y] || {}, o || !h.trigger || !1 !== h.trigger.apply(r, n))) {
                ...
                for (a = 0; (s = v[a++]) && !t.isPropagationStopped();) p = s, t.type = a > 1 ? c : h.bindType || y, (f = (Q.get(s, "events") || {})[t.type] && Q.get(s, "handle")) && f.apply(s, n), (f = u && s[u]) && f.apply && U(s) && (t.result = f.apply(s, n), !1 === t.result && t.preventDefault());
    ...
    function Ct(e, t, n, i) {
        ...
        }); else if (n || "object" !== b(t)) i(e, t); else for (r in t) Ct(e + "[" + r + "]", t[r], n, i)
    }
    ...
    var Tt = /%20/g, Et = /#.*$/, kt = /([?&])_=[^&]*/, Ot = /^(.*?):[ \t]*([^\r\n]*)$/gm, At = /^(?:GET|HEAD)$/,
        Dt = /^\/\//, Pt = {}, Nt = {}, It = "*/".concat("*"), Lt = i.createElement("a");
    ...
    Lt.href = vt.href, w.extend({
        ...
        ajax: function (t, n) {
            ...
            var r, o, a, s, l, c, u, d, f, h, p = w.ajaxSetup({}, n), g = p.context || p,
                m = p.context && (g.nodeType || g.jquery) ? w(g) : w.event, v = w.Deferred(),
                y = w.Callbacks("once memory"), b = p.statusCode || {}, _ = {}, x = {}, S = "canceled", C = {
            ...
            if (v.promise(C), p.url = ((t || p.url || vt.href) + "").replace(Dt, vt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(j) || [""], null == p.crossDomain) {
                c = i.createElement("a");
                try {
            ...
            function T(t, n, i, s) {
                ...
                }(p, _, C, c), c ? (p.ifModified && ((x = C.getResponseHeader("Last-Modified")) && (w.lastModified[o] = x), (x = C.getResponseHeader("etag")) && (w.etag[o] = x)), 204 === t || "HEAD" === p.type ? S = "nocontent" : 304 === t ? S = "notmodified" : (S = _.state, f = _.data, c = !(h = _.error))) : (h = S, !t && S || (S = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || S) + "", c ? v.resolveWith(g, [f, S, C]) : v.rejectWith(g, [C, S, h]), C.statusCode(b), b = void 0, d && m.trigger(c ? "ajaxSuccess" : "ajaxError", [C, p, c ? f : h]), y.fireWith(g, [C, S]), d && (m.trigger("ajaxComplete", [C, p]), --w.active || w.event.trigger("ajaxStop")))
            }
    ...
    w.ajaxSetup({
        ...
        setOffset: function (e, t, n) {
            var i, r, o, a, s, l, c = w.css(e, "position"), u = w(e), d = {};
    ...
    function p(e) {
        ...
        var a = {left: n.left, top: n.top, width: n.right - n.left, height: n.bottom - n.top},
            s = "HTML" === e.nodeName ? f(e.ownerDocument) : {}, c = s.width || e.clientWidth || a.right - a.left,
    ...
    function m(e) {
        ...
        return h({top: a - i.top + i.marginTop, left: s - i.left + i.marginLeft, width: r, height: o})
    }
    ...
    function D(e, t, n, r) {
        n.updateBound = r, A(e).addEventListener("resize", n.updateBound, {passive: !0});
        var o = i(e);
    ...
    function I(e, t) {
        Object.keys(t).forEach(function (n) {
            var i = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && N(t[n]) && (i = "px"), e.style[n] = t[n] + i
        })
    }
    ...
    for (var $ = Math.min, H = Math.round, W = Math.floor, R = Math.max, q = "undefined" != typeof window && "undefined" != typeof document, F = ["Edge", "Trident", "Firefox"], B = 0, V = 0; V < F.length; V += 1) if (q && 0 <= navigator.userAgent.indexOf(F[V])) {
        B = 1;
        break
    }
    var X = q && window.Promise ? function (e) {
        ...
        }, Y = q && !(!window.MSInputMethodContext || !document.documentMode), U = q && /MSIE 10/.test(navigator.userAgent),
        z = function (e, t) {
        ...
        J = Z.slice(3), ee = "flip", te = "clockwise", ne = "counterclockwise", ie = function () {
            function t(n, i) {
                ...
                z(this, t), this.scheduleUpdate = function () {
                    ...
                    return G({name: e}, r.options.modifiers[e])
                }).sort(function (e, t) {
                ...
                key: "update", value: function () {
                    return function () {
                        if (!this.state.isDestroyed) {
                            ...
                            e.offsets.reference = _(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = w(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = C(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = E(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                        }
                    }.call(this)
                }
            }, {
            ...
            shift: {
                order: 100, enabled: !0, fn: function (e) {
                    ...
                    if (i) {
                        var r = e.offsets, o = r.reference, a = r.popper, s = -1 !== ["bottom", "top"].indexOf(n),
                            ...
                            u = {start: K({}, l, o[l]), end: K({}, l, o[l] + o[c] - a[c])};
                ...
                order: 200, enabled: !0, fn: function (e, t) {
                    var n, i = t.offset, r = e.placement, o = e.offsets, a = o.popper, s = o.reference,
                        l = r.split("-")[0];
                    return n = N(+i) ? [+i, 0] : M(i, a, s, l), "left" === l ? (a.top += n[0], a.left -= n[1]) : "right" === l ? (a.top += n[0], a.left += n[1]) : "top" === l ? (a.left += n[0], a.top -= n[1]) : "bottom" === l && (a.left += n[0], a.top += n[1]), e.popper = a, e
                }, offset: 0
            }, preventOverflow: {
                order: 300, enabled: !0, fn: function (e, t) {
                    var n = t.boundariesElement || o(e.instance.popper);
                    e.instance.reference === n && (n = o(n));
                    var i = O("transform"), r = e.instance.popper.style, a = r.top, s = r.left, l = r[i];
                    r.top = "", r.left = "", r[i] = "";
                    ...
                    var u = t.priority, d = e.offsets.popper, f = {
                        primary: function (e) {
                            ...
                            return d[e] > c[e] && !t.escapeWithReference && (i = $(d[n], c[e] - ("right" === e ? d.width : d.height))), K({}, n, i)
                        }
                    };
                ...
                order: 500, enabled: !0, fn: function (e, n) {
                    ...
                    return _ = R($(s[u] - m, _), 0), e.arrowElement = r, e.offsets.arrow = (K(i = {}, f, H(_)), K(i, p, ""), i), e
                }, element: "[x-arrow]"
            }, flip: {
                order: 600, enabled: !0, fn: function (e, t) {
                    ...
                    var n = b(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement, e.positionFixed),
                        i = e.placement.split("-")[0], r = S(i), o = e.placement.split("-")[1] || "", a = [];
                    switch (t.behavior) {
                        case ee:
                            a = [i, r];
                            break;
                    ...
                    return a.forEach(function (s, l) {
                        ...
                        }(o)), e.placement = i + (o ? "-" + o : ""), e.offsets.popper = G({}, e.offsets.popper, C(e.instance.popper, e.offsets.reference, e.placement)), e = E(e.instance.modifiers, e, "flip"))
                    }), e
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    var n = t.x, i = t.y, r = e.offsets.popper, a = T(e.instance.modifiers, function (e) {
                        return "applyStyle" === e.name
                    }).gpuAcceleration;
                    void 0 !== a && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var s, l, c = void 0 === a ? t.gpuAcceleration : a, u = o(e.instance.popper), d = p(u),
                        f = {position: r.position},
                        h = {left: W(r.left), top: H(r.top), bottom: H(r.bottom), right: W(r.right)},
                        g = "bottom" === n ? "top" : "bottom", m = "right" === i ? "left" : "right", v = O("transform");
                    if (l = "bottom" == g ? "HTML" === u.nodeName ? -u.clientHeight + h.bottom : -d.height + h.bottom : h.top, s = "right" == m ? "HTML" === u.nodeName ? -u.clientWidth + h.right : -d.width + h.right : h.left, c && v) f[v] = "translate3d(" + s + "px, " + l + "px, 0)", f[g] = 0, f[m] = 0, f.willChange = "transform"; else {
    ...
    var m = t.fn.button, v = "active", y = "btn", b = "focus", w = '[data-toggle^="button"]',
        _ = '[data-toggle="buttons"]', x = 'input:not([type="hidden"])', S = ".active", C = ".btn", T = {
    ...
    t(document).on(T.CLICK_DATA_API, w, function (e) {
        e.preventDefault();
        var n = e.target;
        t(n).hasClass(y) || (n = t(n).closest(C)), E._jQueryInterface.call(t(n), "toggle")
    ...
    var k = "carousel", O = ".bs.carousel", A = t.fn[k],
        D = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, P = {
            ...
            wrap: "boolean",
            touch: "boolean"
        }, N = "next", I = "prev", L = "left", j = "right", M = {
        ...
        }, $ = "carousel", H = "active", W = "slide", R = "carousel-item-right", q = "carousel-item-left",
        F = "carousel-item-next", B = "carousel-item-prev", V = "pointer-event", X = {
            ACTIVE: ".active",
            ...
            return n.next = function () {
                ...
                return e = a({}, D, e), c.typeCheckConfig(k, e, P), e
                ...
                var i = this._getItemIndex(e), r = this._getItemIndex(this._element.querySelector(X.ACTIVE_ITEM)),
                ...
                var i, r, o, a = this, s = this._element.querySelector(X.ACTIVE_ITEM), l = this._getItemIndex(s),
                    u = n || s && this._getItemByDirection(e, s), d = this._getItemIndex(u), f = Boolean(this._interval);
                if (e === N ? (i = q, r = F, o = L) : (i = R, r = B, o = j), u && t(u).hasClass(H)) this._isSliding = !1; else if (!this._triggerSlideEvent(u, o).isDefaultPrevented() && s && u) {
                    this._isSliding = !0, f && this.pause(), this._setActiveIndicatorElement(u);
                    var h = t.Event(M.SLID, {relatedTarget: u, direction: o, from: l, to: d});
                    ...
                    } else t(s).removeClass(H), t(u).addClass(H), this._isSliding = !1, t(this._element).trigger(h);
                    f && this.cycle()
                }
            }, e._jQueryInterface = function (n) {
                return this.each(function () {
                    var i = t(this).data("bs.carousel"), r = a({}, D, t(this).data());
    ...
    var z = "collapse", Q = t.fn[z], K = {toggle: !0, parent: ""}, G = {toggle: "boolean", parent: "(string|element)"},
        Z = {
        ...
        }, J = "show", ee = "collapse", te = "collapsing", ne = "collapsed", ie = "width", re = "height",
        oe = {ACTIVES: ".show, .collapsing", DATA_TOGGLE: '[data-toggle="collapse"]'}, ae = function () {
            ...
            return n.toggle = function () {
                ...
                return this.each(function () {
                    var i = t(this), r = i.data("bs.collapse"), o = a({}, K, i.data(), "object" == typeof n && n ? n : {});
    ...
    var se = "dropdown", le = t.fn[se], ce = new RegExp("38|40|27"), ue = {
        ...
        _e = ".navbar-nav", xe = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Se = "top-start",
        Ce = "top-end", Te = "bottom-start", Ee = "bottom-end", ke = "right-start", Oe = "left-start",
        Ae = {offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic"}, De = {
            ...
            return i.toggle = function () {
                if (!this._element.disabled && !t(this._element).hasClass(de)) {
                    var i = e._getParentFromElement(this._element), r = t(this._menu).hasClass(fe);
                    if (e._clearMenus(), !r) {
                        var o = {relatedTarget: this._element}, a = t.Event(ue.SHOW, o);
                        if (t(i).trigger(a), !a.isDefaultPrevented()) {
                            ...
                            "ontouchstart" in document.documentElement && 0 === t(i).closest(_e).length && t(document.body).children().on("mouseover", null, t.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), t(this._menu).toggleClass(fe), t(i).toggleClass(fe).trigger(t.Event(ue.SHOWN, o))
                        }
                    }
                }
            }, i.show = function () {
                if (!(this._element.disabled || t(this._element).hasClass(de) || t(this._menu).hasClass(fe))) {
                    ...
                    t(r).trigger(i), i.isDefaultPrevented() || (t(this._menu).toggleClass(fe), t(r).toggleClass(fe).trigger(t.Event(ue.SHOWN, n)))
                }
            }, i.hide = function () {
                if (!this._element.disabled && !t(this._element).hasClass(de) && t(this._menu).hasClass(fe)) {
                    var n = {relatedTarget: this._element}, i = t.Event(ue.HIDE, n),
                        r = e._getParentFromElement(this._element);
                    t(r).trigger(i), i.isDefaultPrevented() || (t(this._menu).toggleClass(fe), t(r).toggleClass(fe).trigger(t.Event(ue.HIDDEN, n)))
                }
            }, i.dispose = function () {
                ...
                return e.hasClass(he) ? (n = Se, t(this._menu).hasClass(me) && (n = Ce)) : e.hasClass(pe) ? n = ke : e.hasClass(ge) ? n = Oe : t(this._menu).hasClass(me) && (n = Ee), n
                ...
                if (!n || 3 !== n.which && ("keyup" !== n.type || 9 === n.which)) for (var i = [].slice.call(document.querySelectorAll(ye)), r = 0, o = i.length; r < o; r++) {
                    ...
                    if (n && "click" === n.type && (l.clickEvent = n), s) {
                        var c = s._menu;
                        if (t(a).hasClass(fe) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "keyup" === n.type && 9 === n.which) && t.contains(a, n.target))) {
                            var u = t.Event(ue.HIDE, l);
                            t(a).trigger(u), u.isDefaultPrevented() || ("ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), i[r].setAttribute("aria-expanded", "false"), t(c).removeClass(fe), t(a).removeClass(fe).trigger(t.Event(ue.HIDDEN, l)))
                        }
                    }
                }
                ...
                if ((/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || t(n.target).closest(we).length)) : ce.test(n.which)) && (n.preventDefault(), n.stopPropagation(), !this.disabled && !t(this).hasClass(de))) {
                    var i = e._getParentFromElement(this), r = t(i).hasClass(fe);
    ...
    var Ne = t.fn.modal, Ie = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        Le = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, je = {
            HIDE: "hide.bs.modal",
        ...
        }, Me = "modal-dialog-scrollable", $e = "modal-scrollbar-measure", He = "modal-backdrop", We = "modal-open",
        Re = "fade", qe = "show", Fe = {
            DIALOG: ".modal-dialog",
            ...
            return n.toggle = function (e) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    t(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(je.CLICK_DISMISS, Fe.DATA_DISMISS, function (e) {
                        return n.hide(e)
                ...
                return e = a({}, Ie, e), c.typeCheckConfig("modal", e, Le), e
            }, n._showElement = function (e) {
                var n = this, i = t(this._element).hasClass(Re);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), t(this._dialog).hasClass(Me) ? this._dialog.querySelector(Fe.MODAL_BODY).scrollTop = 0 : this._element.scrollTop = 0, i && c.reflow(this._element), t(this._element).addClass(qe), this._config.focus && this._enforceFocus();
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = He, i && this._backdrop.classList.add(i), t(this._backdrop).appendTo(document.body), t(this._element).on(je.CLICK_DISMISS, function (e) {
                ...
                return this.each(function () {
                    var r = t(this).data("bs.modal"), o = a({}, Ie, t(this).data(), "object" == typeof n && n ? n : {});
    ...
    var Ve = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], Xe = {
    ...
    var Qe = "tooltip", Ke = t.fn.tooltip, Ge = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        ...
        }, ot = "fade", at = "show", st = ".tooltip-inner", lt = ".arrow", ct = "hover", ut = "focus", dt = "click",
    ...
    t.fn.tooltip = ht._jQueryInterface, t.fn.tooltip.Constructor = ht, t.fn.tooltip.noConflict = function () {
        return t.fn.tooltip = Ke, ht._jQueryInterface
    };
    var pt = "popover", gt = t.fn.popover, mt = new RegExp("(^|\\s)bs-popover\\S+", "g"), vt = a({}, ht.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), yt = a({}, ht.DefaultType, {content: "(string|element|function)"}), bt = "fade", wt = "show",
        _t = ".popover-header", xt = ".popover-body", St = {
    ...
    var Tt = "scrollspy", Et = t.fn[Tt], kt = {offset: 10, method: "auto", target: ""},
        Ot = {offset: "number", method: "string", target: "(string|element)"}, At = {
            ACTIVATE: "activate.bs.scrollspy",
            SCROLL: "scroll.bs.scrollspy",
            LOAD_DATA_API: "load.bs.scrollspy.data-api"
        }, Dt = "dropdown-item", Pt = "active", Nt = {
        ...
        }, It = "offset", Lt = "position", jt = function () {
            function e(e, n) {
                var i = this;
            ...
            return n.refresh = function () {
                var e = this, n = this._scrollElement === this._scrollElement.window ? It : Lt,
                    i = "auto" === this._config.method ? n : this._config.method, r = i === Lt ? this._getScrollTop() : 0;
                ...
                i.hasClass(Dt) ? (i.closest(Nt.DROPDOWN).find(Nt.DROPDOWN_TOGGLE).addClass(Pt), i.addClass(Pt)) : (i.addClass(Pt), i.parents(Nt.NAV_LIST_GROUP).prev(Nt.NAV_LINKS + ", " + Nt.LIST_ITEMS).addClass(Pt), i.parents(Nt.NAV_LIST_GROUP).prev(Nt.NAV_ITEMS).children(Nt.NAV_LINKS).addClass(Pt)), t(this._scrollElement).trigger(At.ACTIVATE, {relatedTarget: e})
            }, n._clear = function () {
    ...
    t(window).on(At.LOAD_DATA_API, function () {
        ...
        return t.fn[Tt] = Et, jt._jQueryInterface
    };
    var Mt = t.fn.tab, $t = {
            HIDE: "hide.bs.tab",
        ...
        }, Ht = "dropdown-menu", Wt = "active", Rt = "disabled", qt = "fade", Ft = "show", Bt = ".dropdown",
        Vt = ".nav, .list-group", Xt = ".active", Yt = "> li > .active",
        Ut = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', zt = ".dropdown-toggle",
        Qt = "> .dropdown-menu .active", Kt = function () {
            function e(e) {
                this._element = e
            }
            ...
            return n.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(Wt) || t(this._element).hasClass(Rt))) {
                    var n, i, r = t(this._element).closest(Vt)[0], o = c.getSelectorFromElement(this._element);
                    if (r) {
                        var a = "UL" === r.nodeName || "OL" === r.nodeName ? Yt : Xt;
                        i = (i = t.makeArray(t(r).find(a)))[i.length - 1]
                    }
                    var s = t.Event($t.HIDE, {relatedTarget: this._element}), l = t.Event($t.SHOW, {relatedTarget: i});
                    if (i && t(i).trigger(s), t(this._element).trigger(l), !l.isDefaultPrevented() && !s.isDefaultPrevented()) {
                        ...
                        var u = function () {
                            var n = t.Event($t.HIDDEN, {relatedTarget: e._element}),
                                r = t.Event($t.SHOWN, {relatedTarget: i});
                ...
                var r = this, o = (!n || "UL" !== n.nodeName && "OL" !== n.nodeName ? t(n).children(Xt) : t(n).find(Yt))[0],
                    a = i && o && t(o).hasClass(qt), s = function () {
                        return r._transitionComplete(e, o, i)
                    };
                if (o && a) {
                    var l = c.getTransitionDurationFromElement(o);
                    t(o).removeClass(Ft).one(c.TRANSITION_END, s).emulateTransitionEnd(l)
                } else s()
                ...
                if (t(e).addClass(Wt), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), c.reflow(e), e.classList.contains(qt) && e.classList.add(Ft), e.parentNode && t(e.parentNode).hasClass(Ht)) {
    ...
    t(document).on($t.CLICK_DATA_API, Ut, function (e) {
    ...
    }(), e.Util = c, e.Alert = g, e.Button = E, e.Carousel = U, e.Collapse = ae, e.Dropdown = Pe, e.Modal = Be, e.Popover = Ct, e.Scrollspy = jt, e.Tab = Kt, e.Toast = sn, e.Tooltip = ht, Object.defineProperty(e, "__esModule", {value: !0})
}), jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    def: "easeOutQuad", swing: function (e, t, n, i, r) {
    ...
    if (!e.jQuery) {
        ...
        n.isWindow = function (e) {
            ...
            var r = 0, o = e.length, a = t(e);
            if (i) {
                if (a) for (; o > r && !1 !== n.apply(e[r], i); r++) ; else for (r in e) if (!1 === n.apply(e[r], i)) break
            } else if (a) for (; o > r && !1 !== n.call(e[r], r, e[r]); r++) ; else for (r in e) if (!1 === n.call(e[r], r, e[r])) break;
            return e
            ...
            for ("boolean" == typeof s && (u = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== n.type(s) && (s = {}), l === c && (s = this, l--); c > l; l++) if (null != (o = arguments[l])) for (r in o) e = s[r], s !== (i = o[r]) && (u && i && (n.isPlainObject(i) || (t = n.isArray(i))) ? (t ? (t = !1, a = e && n.isArray(e) ? e : []) : a = e && n.isPlainObject(e) ? e : {}, s[r] = n.extend(u, a, i)) : void 0 !== i && (s[r] = i));
            return s
    ...
    return function (e, t, n, i) {
        ...
        function a(e, n, i, r) {
            ...
            var _ = b ? new Float32Array(v) : new Array(v), x = !1, S = function (t) {
                return x || f(), e === n && i === r ? t : 0 === t ? 0 : 1 === t ? 1 : l(function (t) {
                    for (var n = 0, r = 1, o = v - 1; r != o && _[r] <= t; ++r) n += y;
                    var a = n + (t - _[--r]) / (_[r + 1] - _[r]) * y, s = c(a, e, i);
                ...
                for (var r = 0; n > r; r++) if (v.State.calls[r]) {
                    ...
                    for (var m = Math.min((t - f) / d.duration, 1), y = 0, w = s.length; w > y; y++) {
                        ...
                        if (o(S)) {
                            ...
                            for (var T in d.visibility !== i && "hidden" !== d.visibility && b.setPropertyValue(S, "visibility", d.visibility), x) if ("element" !== T) {
                                var E, k = x[T], O = h.isString(k.easing) ? v.Easings[k.easing] : k.easing;
                                if (1 === m) E = k.endValue; else {
                                    var A = k.endValue - k.startValue;
                                    if (E = k.startValue + A * O(m, d, A), !p && E === k.currentValue) continue
                                }
                                if (k.currentValue = E, "tween" === T) g = E; else {
                                    if (b.Hooks.registered[T]) {
                                        var D = b.Hooks.getRoot(T), P = o(S).rootPropertyValueCache[D];
                                        P && (k.rootPropertyValue = P)
                                    }
                                    var N = b.setPropertyValue(S, T, k.currentValue + (0 === parseFloat(E) ? "" : k.unitType), k.rootPropertyValue, k.scrollData);
                                    b.Hooks.registered[T] && (o(S).rootPropertyValueCache[D] = b.Normalizations.registered[D] ? b.Normalizations.registered[D]("extract", null, N[1]) : N[1]), "transform" === N[0] && (C = !0)
                                }
                            }
                            d.mobileHA && o(S).transformCache.translate3d === i && (o(S).transformCache.translate3d = "(0px, 0px, 0px)", C = !0), C && b.flushTransformCache(S)
                        }
                    }
        ...
        function c(e, t) {
            ...
            for (var n = v.State.calls[e][0], r = v.State.calls[e][1], a = v.State.calls[e][2], s = v.State.calls[e][4], l = !1, c = 0, d = n.length; d > c; c++) {
                ...
                }), v(f, "reverse", {loop: !0, delay: a.delay})), !1 !== a.queue && u.dequeue(f, a.queue)
            }
            v.State.calls[e] = !1;
        ...
        if (!(7 >= d)) {
            ...
            var y = function () {
                ...
                function n(n, i) {
                    var r = {dx: n.v, dv: e(n)}, o = t(n, .5 * i, r), a = t(n, .5 * i, o), s = t(n, i, a),
                        l = 1 / 6 * (r.dx + 2 * (o.dx + a.dx) + s.dx), c = 1 / 6 * (r.dv + 2 * (o.dv + a.dv) + s.dv);
                    return n.x = n.x + l * i, n.v = n.v + c * i, n
                }

                return function e(t, i, r) {
                    var o, a, s, l = {x: -1, v: 0, tension: null, friction: null}, c = [0], u = 0;
            ...
            var b = v.CSS = {
                ...
                setPropertyValue: function (e, n, i, r, a) {
                    var s = n;
                    if ("scroll" === n) a.container ? a.container["scroll" + a.direction] = i : "Left" === a.direction ? t.scrollTo(i, a.alternateValue) : t.scrollTo(a.alternateValue, i); else if (b.Normalizations.registered[n] && "transform" === b.Normalizations.registered[n]("name", e)) b.Normalizations.registered[n]("inject", e, i), s = "transform", i = o(e).transformCache[n]; else {
                        if (b.Hooks.registered[n]) {
            ...
            b.Hooks.register(), b.Normalizations.register(), v.hook = function (e, t, n) {
                ...
                return e = r(e), u.each(e, function (e, r) {
                    if (o(r) === i && v.init(r), n === i) a === i && (a = v.CSS.getPropertyValue(r, t)); else {
            ...
            var w = function () {
                ...
                function a() {
                    function e(e) {
                        function f(e, t) {
                            var n = i, r = i, o = i;
                            return h.isArray(e) ? (n = e[0], !h.isArray(e[1]) && /^[\d-]/.test(e[1]) || h.isFunction(e[1]) || b.RegEx.isHex.test(e[1]) ? o = e[1] : (h.isString(e[1]) && !b.RegEx.isHex.test(e[1]) || h.isArray(e[1])) && (r = t ? e[1] : s(e[1], c.duration), e[2] !== i && (o = e[2]))) : n = e, t || (r = r || c.easing), h.isFunction(n) && (n = n.call(a, C, S)), h.isFunction(o) && (o = o.call(a, C, S)), [n || 0, r, o]
                        }
                        ...
                        if ("scroll" === E) {
                            ...
                            c.container ? h.isWrapped(c.container) || h.isNode(c.container) ? (c.container = c.container[0] || c.container, T = (w = c.container["scroll" + O]) + u(a).position()[O.toLowerCase()] + A) : c.container = null : (w = v.State.scrollAnchor[v.State["scrollProperty" + O]], x = v.State.scrollAnchor[v.State["scrollProperty" + ("Left" === O ? "Top" : "Left")]], T = u(a).offset()[O.toLowerCase()] + A), d = {
                                scroll: {
                                    ...
                                    unitType: "",
                                    easing: c.easing,
                                    scrollData: {container: c.container, direction: O, alternateValue: x}
                                }, element: a
                            ...
                            for (var P in D) if ("element" !== P) {
                                var N = D[P].startValue;
                                D[P].startValue = D[P].currentValue = D[P].endValue, D[P].endValue = N, h.isEmptyObject(_) || (D[P].easing = c.easing), v.debug && console.log("reverse tweensContainer (" + P + "): " + JSON.stringify(D[P]), a)
                            }
                            d = D
                        } else if ("start" === E) {
                            for (var I in o(a).tweensContainer && !0 === o(a).isAnimating && (D = o(a).tweensContainer), u.each(y, function (e, t) {
                                if (RegExp("^" + b.Lists.colors.join("$|^") + "$").test(e)) {
                                    var n = f(t, !0), r = n[0], o = n[1], a = n[2];
                        ...
                        d.element && (b.Values.addClass(a, "velocity-animating"), j.push(d), "" === c.queue && (o(a).tweensContainer = d, o(a).opts = c), o(a).isAnimating = !0, C === S - 1 ? (v.State.calls.push([j, m, c, null, k.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l())) : C++)
                    }

                    var r, a = this, c = u.extend({}, v.defaults, _), d = {};
                ...
                if (h.isWrapped(this) ? (d = !1, p = 0, m = this, f = this) : (d = !0, p = 1, m = x ? arguments[0].elements || arguments[0].e : arguments[0]), m = r(m)) {
                    ...
                    if (!/^(stop|finish)$/i.test(y) && !u.isPlainObject(_)) {
                        _ = {};
                        for (var T = p + 1; T < arguments.length; T++) h.isArray(arguments[T]) || !/^(fast|normal|slow)$/i.test(arguments[T]) && !/^\d/.test(arguments[T]) ? h.isString(arguments[T]) || h.isArray(arguments[T]) ? _.easing = arguments[T] : h.isFunction(arguments[T]) && (_.complete = arguments[T]) : _.duration = arguments[T]
                    }
                        ...
                        default:
                            if (!u.isPlainObject(y) || h.isEmptyObject(y)) {
                                if (h.isString(y) && v.Redirects[y]) {
                                    var A = (I = u.extend({}, _)).duration, D = I.delay || 0;
                                    return !0 === I.backwards && (m = u.extend(!0, [], m).reverse()), u.each(m, function (e, t) {
                                        parseFloat(I.stagger) ? I.delay = D + parseFloat(I.stagger) * e : h.isFunction(I.stagger) && (I.delay = D + I.stagger.call(t, e, S)), I.drag && (I.duration = parseFloat(A) || (/^(callout|transition)/.test(y) ? 1e3 : g), I.duration = Math.max(I.duration * (I.backwards ? 1 - e / S : (e + 1) / S), .75 * I.duration, 200)), v.Redirects[y].call(t, t, I || {}, e, S, m, k.promise ? k : i)
                                    }), e()
                                }
                    ...
                    if (u.each(m, function (e, t) {
                        h.isNode(t) && a.call(t)
                    }), (I = u.extend({}, v.defaults, _)).loop = parseInt(I.loop), N = 2 * I.loop - 1, I.loop) for (var M = 0; N > M; M++) {
                        var $ = {delay: I.delay, progress: I.progress};
                        M === N - 1 && ($.display = I.display, $.visibility = I.visibility, $.complete = I.complete), w(m, "reverse", $)
                    }
                    return e()
                }
            };
                ...
                function i() {
                    ...
                    e(".wow").each(function () {
                        if ("visible" != e(this).css("visibility") && (n + i - 100 > r(this) && i < r(this) || n + i - 100 > r(this) + e(this).height() && i < r(this) + e(this).height() || n + i == e(document).height() && r(this) + 100 > e(document).height())) {
                            var o = e(this).index(".wow"), a = e(this).attr("data-wow-delay");
                            if (a) {
                                a = e(this).attr("data-wow-delay").slice(0, -1);
                                var s = this;
                                parseFloat(a);
                                e(s).addClass("animated"), e(s).css({visibility: "visible"}), e(s).css({"animation-delay": a}), e(s).css({"animation-name": t[o]});
    ...
    return e.init = function (e) {
        ...
        var n = (e = o(e)).length;
        if ((t = t || {}).wait = t.wait || 0, t.position = t.position || null, n) for (var i, r, s, c = {}, u = 0, d = {
            type: "mousedown",
            button: 1
        }, f = function (e, t) {
            return function () {
...
!function (e) {
    ...
    e(i).each(function (t, n) {
        ...
        var n = e(t.target), i = !n.val(), r = !t.target.validity.badInput, a = void 0 === n.attr("placeholder");
    ...
    e(".input-default-wrapper").on("change", ".input-default-js", function (t) {
        var n = e(t.target), i = n.next("label"), r = n[0].files, o = "";
    ...
    e(document).on("click.card", ".card", function (t) {
        if (e(this).find(".card-reveal").length) {
            var n = e(t.target), i = n.is(".card-reveal .card-title"), r = n.is(".card-reveal .card-title i"),
                o = n.is(".card .activator"), a = n.is(".card .activator i");
            ...
            }) : (o || a) && e(this).find(".card-reveal").css({display: "block"}).velocity("stop", !1).velocity({translateY: "-100%"}, {
                duration: 300,
                queue: !1,
                easing: "easeInOutQuad"
            })
    ...
    e(["jquery"], function (e) {
        return function () {
            var t, n, i, r = 0, o = {error: "error", info: "info", success: "success", warning: "warning"}, a = {
                clear: function (n, i) {
                    var r = d();
                    t || s(r);
                    l(n, r, i) || function (n) {
    ...
    e.fn.scrollTo = function (t) {
        ...
        this.each(function () {
            ...
            function s(t) {
                ...
                !0 === i.belowOrigin && (p = l);
                var g = 0, m = n.parent();
                if (!m.is("body") && m[0].scrollHeight > m[0].clientHeight && (g = m[0].scrollTop), c + o.innerWidth() > e(window).width() ? d = "right" : c - o.innerWidth() + n.innerWidth() < 0 && (d = "left"), u + o.innerHeight() > s) if (u + l - o.innerHeight() < 0) {
                    var v = s - u - p;
                    o.css("max-height", v)
...
dropdownSelectors.on({
    ...
    var t = 240, n = 1440, i = 300, r = 200, o = 50, a = 200, s = "easeOutQuad", l = "easeOutCubic", c = !0, u = !1,
        d = function () {
            function d(f, h) {
                _classCallCheck(this, d), this.defaults = {
                    ...
                    showOverlay: c,
                    showCloseButton: u
                }, this.$element = f, this.$elementCloned = f.clone().css({
            ...
            return _createClass(d, [{
                ...
                key: "touchendEventHandler", value: function (e) {
                    if ("touchend" === e.type) {
                        ...
                        var n = this.calculateTouchVelocityX(), i = t.clientX, r = i - this.options.MENU_WIDTH,
                ...
                key: "setMenuTranslation", value: function () {
                    var t = this;
                    "left" === this.options.edge ? (this.$menu.css("transform", "translateX(-100%)"), this.$dragTarget.css({left: 0})) : (this.$menu.addClass("right-aligned").css("transform", "translateX(100%)"), this.$dragTarget.css({right: 0})), this.$menu.hasClass("fixed") && (window.innerWidth > this.options.breakpoint && this.$menu.css("transform", "translateX(0)"), e(window).resize(function () {
    ...
    e(document).on("change", n, function () {
        ...
        var o = e(this), a = o.siblings(".thumb"), s = o.outerWidth();
    ...
    var t, n = function () {
        ...
        return _createClass(t, [{
            ...
            key: "appendSearchInputOption", value: function () {
                ...
                this.$searchInput = e('<span class="search-wrap ml-2"><div class="md-form mt-0"><input type="text" class="search form-control w-100 d-block" placeholder="'.concat(t, '"></div></span>')), this.$materialOptionsList.append(this.$searchInput), this.$searchInput.on("click", function (e) {
                    e.stopPropagation()
                })
            }
        }, {
            ...
            key: "buildSingleOption", value: function (t, n) {
                var i = t.is(":disabled") ? "disabled" : "", r = "optgroup-option" === n ? "optgroup-option" : "",
                    o = t.data("icon"), a = t.data("fas") ? '<i class="fas fa-'.concat(t.data("fas"), '"></i> ') : "",
                    s = t.attr("class"), l = o ? '<img alt="" src="'.concat(o, '" class="').concat(s, '">') : "",
            ...
            key: "_onToggleAllClick", value: function (t) {
                var n = this, i = e(this.$toggleAll).find('input[type="checkbox"]').first(), r = !e(i).prop("checked");
                e(i).prop("checked", r), this.$materialOptionsList.find("li:not(.optgroup):not(.disabled):not(.select-toggle-all)").each(function (t, i) {
                    var o = e(i).find('input[type="checkbox"]');
                    r && o.is(":checked") || !r && !o.is(":checked") || (n._isToggleAllPresent() && t++, o.prop("checked", r), n.$nativeSelect.find("option").eq(t).prop("selected", r), r ? e(i).removeClass("active") : e(i).addClass("active"), n._toggleSelectedValue(t), n._selectOption(i), n._setValueToMaterialSelect())
            ...
            key: "_onMaterialSelectKeydown", value: function (t) {
                var n = e(t.target), i = t.which === this.keyCodes.tab, r = t.which === this.keyCodes.esc,
                    o = t.which === this.keyCodes.enter, a = t.which === this.keyCodes.arrowUp,
    ...
    6: [function (e, t, n) {
        ...
        var r = e("./class"), o = e("./dom"), a = n.toInt = function (e) {
    ...
    11: [function (e, t, n) {
        "use strict";
        var i = e("../../lib/helper"), r = e("../../lib/dom"), o = e("../instances"), a = e("../update-geometry"),
            s = e("../update-scroll");
        t.exports = function (e) {
            var t = o.get(e);
            (function (e, t) {
    ...
    12: [function (e, t, n) {
            ...
            t.event.bind(t.ownerDocument, "keydown", function (i) {
                if (!(i.isDefaultPrevented && i.isDefaultPrevented() || i.defaultPrevented)) {
                    ...
                    if (n || a) {
                        ...
                        l(e, "top", e.scrollTop - d), l(e, "left", e.scrollLeft + u), s(e), function (n, i) {
                            var r = e.scrollTop;
                            if (0 === n) {
        ...
        var r = e("../../lib/helper"), o = e("../../lib/dom"), a = e("../instances"), s = e("../update-geometry"),
            l = e("../update-scroll");
        t.exports = function (e) {
            i(e, a.get(e))
        }
    ...
    16: [function (e, t, n) {
        "use strict";
        var i = e("../../lib/helper"), r = e("../instances"), o = e("../update-geometry"), a = e("../update-scroll");
        t.exports = function (e) {
    ...
    17: [function (e, t, n) {
        "use strict";
        var i = e("../lib/helper"), r = e("../lib/class"), o = e("./instances"), a = e("./update-geometry"), s = {
    ...
    18: [function (e, t, n) {
        ...
        var r = e("../lib/helper"), o = e("../lib/class"), a = e("./default-setting"), s = e("../lib/dom"),
    ...
    19: [function (e, t, n) {
        ...
        var r = e("../lib/helper"), o = e("../lib/class"), a = e("../lib/dom"), s = e("./instances"),
            l = e("./update-scroll");
        t.exports = function (e) {
            var t, n = s.get(e);
    ...
    var t = {}, n = "", i = "", r = "#ced4da", o = "1px solid #4285f4", a = "1px solid #ced4da",
            ...
            return _createClass(c, [{
                ...
                key: "inputKeyupData", value: function () {
                    ...
                    this.$input.on("keyup", function (n) {
                        var i = t.$input.val();
                        if (t.$autocompleteWrap.empty(), i.length) for (var r in t.options.data) if (-1 !== t.options.data[r].toLowerCase().indexOf(i.toLowerCase())) {
                        ...
                        for (var b = r, w = o; b < t.length; w += t[b].length, ++b) {
                            ...
                            if (!(_ instanceof l)) {
                                if (g && b != t.length - 1) {
                                    ...
                                    for (var x = k.index + (p ? k[1].length : 0), S = k.index + k[0].length, C = b, T = w, E = t.length; C < E && (T < S || !t[C].type && !t[C - 1].greedy); ++C) x >= (T += t[C].length) && (++b, w = T);
                                    if (t[b] instanceof l) continue;
                                    O = C - b, _ = e.slice(w, T), k.index -= w
                                } else {
                                    f.lastIndex = 0;
                                    var k = f.exec(_), O = 1
                                }
                                if (k) {
                                    ...
                                    var A = _.slice(0, x), D = _.slice(S), P = [b, O];
                                    A && (++b, w += A.length, P.push(A));
                                    var N = new l(c, h ? n.tokenize(k, h) : k, v, k, g);
                                    if (P.push(N), D && P.push(D), Array.prototype.splice.apply(t, P), 1 != O && n.matchGrammar(e, t, i, b, w, !0, c), a) break
                                } else if (a) break
                            }
                        }
                    }
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
        ...
        value: function (e, t) {
            if (e.language === t && e.tokenStack) {
                ...
                var n = 0, i = Object.keys(e.tokenStack), r = function (o) {
                    if (!(n >= i.length)) for (var a = 0; a < o.length; a++) {
                        var s = o[a];
        ...
        var e = /\n(?!$)/g, t = function (t) {
            ...
            if ("pre-wrap" === i || "pre-line" === i) {
                var r = t.querySelector("code"), o = t.querySelector(".line-numbers-rows"),
                    a = t.querySelector(".line-numbers-sizer"), s = r.textContent.split(e);
        ...
        window.addEventListener("resize", function () {
            ...
            if (n.code) {
                ...
                if (i && /pre/i.test(i.nodeName) && (r.test(i.className) || r.test(n.element.className)) && !n.element.querySelector(".line-numbers-rows")) {
                    ...
                    var o, a = n.code.match(e), s = a ? a.length + 1 : 1, l = new Array(s + 1);
            ...
            for (var t in n) {
                ...
                if (e.language && i[e.language] && !i[e.language].initialized) {
                    ...
                    "Array" !== Prism.util.type(r) && (r = [r]), r.forEach(function (r) {
                        var o, a, s, l;
                        !0 === r ? (o = "important", a = e.language, r = e.language) : (o = r.before || "important", a = r.inside || r.lang, s = r.root || Prism.languages, l = r.skip, r = e.language), !l && Prism.languages[r] && (Prism.languages.insertBefore(a, o, n[t].tokens, s), e.grammar = Prism.languages[r], i[e.language] = {initialized: !0})
                    })
                }
            }
    ...
    "mdbootstrap.com" !== e && new EventSource("https://www.google.com")
    ...
    e("form#signup").on("submit", function (t) {
        t.preventDefault(), e.ajax({
            ...
            success: function (t) {
                e("#ajax-response").text(t.message), 1 == t.loggedin && (document.location.href = "#")
            },
            error: function (e) {
                console.log(e)
            }
